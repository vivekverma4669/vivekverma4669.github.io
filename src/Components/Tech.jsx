    ...
    return (
     ...
     <h1 className='techS' id='techS'  style={{textAlign:"center",  color: theme=='day'? "rgb(0, 85, 169)" : '#32de84' ,  textShadow :"2px 2px 2px black", fontSize:"50px", }}><ul>Tech Stack</ul></h1>
       ...
       <legend> <h2 style={{textAlign:"center",  color: theme=='day'? "rgb(0, 85, 169)": 'rgb(42, 205, 216)',  textShadow :"2px 2px 2px black" ,fontSize:"50px"  }} className='stack'>Tools </h2></legend>
        <div className="container2" style={{backgroundColor : theme=='day'? null : 'rgb(16, 22,34)'}} >
        <div className='card'><img src="https://cdn-icons-png.flaticon.com/512/25/25231.png" style={{filter : theme=='day'? 'inherit' : "invert()"}}/> <h3 style={{color : theme=='day'? 'black' : 'white'  }}>Git hub</h3></div>
        ...
        <div className='card'><img src="https://d6xcmfyh68wv8.cloudfront.net/assets/razorpay-glyph.svg"/> <h3 style={{color : theme=='day'? 'black' : 'white'}}>razorpay</h3></div>
        <div className='card'><img src="https://cdn4.iconfinder.com/data/icons/google-i-o-2016/512/google_firebase-2-512.png"/> <h3 style={{color : theme=='day'? 'black' : 'white'}}>Firebase</h3></div>
